<cfcomponent output="false">
	...
	<cffunction name="GenerateXML"  hint="I generate XML data for FusionCharts" access="public" output="false" returntype="xml">
		...
		<cfscript> 
		local.strXML = "<graph caption='#arguments.name# #arguments.symbol#' yAxisMinValue='0' yAxisMaxValue='60' canvasBorderColor='DAE1E8' canvasBgColor='FFFFFF' bgColor='EEF2FB' numDivLines='9' divLineColor='DAE1E8' decimalPrecision='2' numberPrefix='$' showNames='1' bearBorderColor='E33C3C' bearFillColor='B00F1F' bullBorderColor='1F3165' baseFontColor='444C60' outCnvBaseFontColor='444C60' hoverCapBorderColor='DAE1E8' hoverCapBgColor='FFFFFF' rotateNames='0'>";
